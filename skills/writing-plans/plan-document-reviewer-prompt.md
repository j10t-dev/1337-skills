...
Subagent/delegation tool (general-purpose):
  ...
  prompt: |
    ...
    **Design doc for reference:** [DESIGN_FILE_PATH]
    ...
    | Baseline | Plan carries design-stage evidence and unresolved constraints, specifies required checks and fills missing or invalidated evidence. Reuse applicable results rather than commissioning another baseline run. |

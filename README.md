...
- **Verification and review.** Compare required checks and elapsed times with a pre-edit baseline. Reviewers own code review; controllers use their verdicts rather than reviewing again. Fix and re-review until clean, then absorb final fixes into the relevant feature commits. Agree broader repairs with the user.

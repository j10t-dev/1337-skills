...
- **Conditional SDD references.** Root `SKILL.md` defines execution and the progress tracker. Read `review-handling.md` for feedback or blockers and `recovery.md` when resuming.
